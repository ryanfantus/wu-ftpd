/****************************************************************************  
  ...
  $Id: getcwd.c,v 1.9 2011/10/20 22:58:13 wmaton Exp $
...
#endif /* (SYSVREL != 0 && !defined(d_fileno)) || defined(_VMS_POSIX) || \ */ 
     ...
     size_t pathlen;
{
	...
	if (st_cur.st_ino == st_root.st_ino &&
	    ...
	    (void) strlcpy(pathname, *pathptr != '/' ? "/" : pathptr, pathlen);
	    return pathname;
	}
