/****************************************************************************    
  ...
  $Id: loadavg.c,v 1.9 2011/10/20 22:58:10 wmaton Exp $ 
...
#  endif /* !(defined(_AIX3) || defined(_AIX4)) */ 
	...
	if (Nl[X_AVENRUN].n_value == 0)
	    return (-1);
#  if defined(NAMELISTMASK)
	Nl[X_AVENRUN].n_value &= NAMELISTMASK;
#  endif /* defined(NAMELISTMASK) */ 
...
#  if !defined(_PATH_LOADAVG)
#    define _PATH_LOADAVG "/proc/loadavg"
#  endif /* !defined(_PATH_LOADAVG) */ 
...
#  if !defined(_PATH_AVENRUN)
#    define _PATH_AVENRUN "/dev/table/avenrun"
#  endif /* !defined(_PATH_AVENRUN) */ 
